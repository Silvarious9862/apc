...
void __interrupt __far alarm(void);
...
//#define BEEP() __asm mov bx,0 __asm mov ax, 0E07h __asm int 10h
...
// вектора будильника
void (__interrupt __far *old_4a)(void);
